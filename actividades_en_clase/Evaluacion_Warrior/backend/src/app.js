...
const warriorRoutes = require("./routes/warrior_routes");
const raceTypeRoutes = require("./routes/raceType_routes");
...
app.use('/api-v1/warrior', warriorRoutes);
app.use('/api-v1/raceType', raceTypeRoutes);
